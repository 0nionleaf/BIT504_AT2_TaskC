...
public class Board {
	...
	public boolean isDraw() {
		...
		// Checks whether the game has ended in a draw. If any cells are empty, return false.
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		// check if the player has 3 in the diagonal in the other direction
