...
public class GameMain extends JPanel implements MouseListener{
	...
	// variable for the current game state (updated throughout the game)
	...
	public GameMain() {   
		...
		// event listener for mouse position and mouse clicks          
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				// window closes when close button is pressed
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				// checks which player has won and updates the currentstate to the appropriate gamestate for the winner
